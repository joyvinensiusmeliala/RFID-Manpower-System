<div class="modal fade tambahworkers" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form role="form" name="formdata" enctype="multipart/form-data" method="post" action="{{url("workers/store")}}">
            {{csrf_field()}} 
        <div class="modal-body">
            ...
            <div class="field item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <select class="select2 form-control" tabindex="-1" id="jabatan_id" name="jabatan_id" style="font-size:13px;width:100%;" onchange="getGate()">
...
function preview_foto(input){
                ...
                success: function(data){
                    ...
                    $("#gate_id").append('<option selected disabled>Pilih Gate</option>');
                        $.each(data,function(placement,row){
                            console.log("gate_id>>>>",row.id);
                            $("#gate_id").append('<option value="'+row.id+'">'+row.gate+'</option>');
                        });    
                    }
                });
            }
    ...
    // Get Divisi from Project 
    function getDivisi(val){
        var project_id = $("#project_id").val();

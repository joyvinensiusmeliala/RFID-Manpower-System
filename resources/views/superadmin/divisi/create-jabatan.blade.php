      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="field item form-group">
                <label class="col-form-label col-md-3 col-sm-3  label-align">Nama Posisi<span class="required">*</span></label>
                <div class="col-md-6 col-sm-6">
                    <input class="form-control fonts" data-validate-length-range="6" data-validate-words="2" name="nama" id="nama" required="required" placeholder="Masukkan Nama Posisi"/>
                </div>
            </div>

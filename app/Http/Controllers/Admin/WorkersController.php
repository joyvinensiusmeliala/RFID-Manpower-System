...
class WorkersController extends Controller
{
    ...
    {
        $data['workers'] = Workers::where('project_id', Auth::user()->project_id)->get();
    ...
    public function store(Request $request)
    {
        try{
            ...
            return redirect('/workers_')->with('success', 'Berhasil menyimpan data');
        }
        catch(\Exception $e){
            return redirect('/workers_')->with('failed', 'Silahkan Cek Kembali Inputan Anda');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        // $get_workers = Workers::where('id', $id)->first();
        // $empty_rfid = RFID::where('nik', $get_workers->nik)->first();
        // $empty_rfid->nik = NULL ;
        // $empty_rfid->save();
